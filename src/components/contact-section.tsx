...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-1  min-h-[calc(70vh-6rem)] flex items-center justify-center bg-gray-900">
              ...
              <div className="rounded-lg border bg-card p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <Mail className="h-5 w-5 text-muted-foreground text-white" />
                    <p className="text-white">mark.fahim50@gmail.com</p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <MapPin className="h-5 w-5 text-muted-foreground text-white" />
                    <p className="text-white">AI Researcher, Pennsylvania State University, USA</p>
                  </div>
                </div>
                
                <h3 className="text-xl font-bold mt-6 mb-4 text-white">Connect with Me</h3>
